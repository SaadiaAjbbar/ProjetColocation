...
Route::middleware(['auth', 'admin'])->group(function () {
   ...
   Route::get('admin/colocations/{colocation}/dashboard',[ColocationController::class, 'dashboard'])->name('colocation.dashboard');

    Route::get('admin/colocations/{colocation}/categories',[CategoryController::class, 'index'])->name('admin.categories.index');

    Route::get('admin/colocations/{colocation}/categories/create',[CategoryController::class, 'create'])->name('admin.categories.create');

    Route::post('admin/colocations/{colocation}/categories',[CategoryController::class, 'store'])->name('admin.categories.store');
